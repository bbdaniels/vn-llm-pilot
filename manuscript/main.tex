...
\author{
  ...
  \small $^{3}$ Partnership for Health Advancement in Vietnam (HAIVN), Beth Israel Deaconess Medical Center (BIDMC), Hanoi, Vietnam \\
  \small $^{4}$ Harvard Medical School, Boston, MA, USA \\
  \small $^{5}$ Brigham and Women's Hospital, Boston, MA, USA \\[4pt]
