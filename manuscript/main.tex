...
\begin{figure}[htbp]
  ...
  \caption{Item-level sensitivity and specificity of LLM coding against human coding. Panel A: coding from translated English transcripts. Panel B: coding directly from Vietnamese transcripts. Each point represents one checklist item. Items above the dashed line of unity have specificity exceeding sensitivity.}
  \label{fig:agreement}
\end{figure}
